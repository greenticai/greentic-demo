# component-betterstack-incident
...
`target/wasm32-wasip2/release/component_betterstack_incident.wasm`.
Update the manifest hash by running `greentic-component hash component.manifest.json`.
Validate the artifact by running
`greentic-component doctor target/wasm32-wasip2/release/component_betterstack_incident.wasm --manifest component.manifest.json`.

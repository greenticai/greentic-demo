...
`target/wasm32-wasip2/release/component_http.wasm`.
Update the manifest hash by running `greentic-component hash component.manifest.json`.
Validate the artifact by running
`greentic-component doctor target/wasm32-wasip2/release/component_http.wasm --manifest component.manifest.json`.
